...
def main():
    ...
    analyses['EXO-23-017'] = ['results_exo_23_017/h2lim_20250226_Hino_neg_allEEMM_neg_0.0_log_smooth1k5a_dMc1n1.root', 'limitGraph_0', 'limitGraph_obs', ROOT.kMagenta + 2]
    ...
    mg = ROOT.TMultiGraph()
    legend = ROOT.TLegend(0.61, 0.28-0.07*(len(analyses)-3), 0.88, 0.53)
    ...
    base_hist.GetXaxis().SetRangeUser(99,250)
