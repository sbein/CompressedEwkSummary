...
def main():
    analyses = {}
    analyses['Disappearing Tracks'] = ['results_sus_21_006/PureHiggsino_DTRun2_results.root', 'Exp_PureHiggsino_DTRun2', 'Obs_PureHiggsino_DTRun2', ROOT.kViolet-1]#ROOT.kSpring+2
    analyses['Isolated soft Track'] = ['results_sus_24_012/PureHiggsino_SDPRun2_results.root', 'Exp_PureHiggsino_SDPRun2', 'Obs_PureHiggsino_SDPRun2', ROOT.kGreen-1]# ROOT.kOrange-1
    ...
    if drawRadidativeBound:
        ...
        dmrad_chipm_chi10.SetLineColor(ROOT.kOrange+2)
        dmrad_chipm_chi10.SetLineWidth(2)
        dmrad_chipm_chi10.SetLineStyle(ROOT.kDashed)        
